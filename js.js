...
let numericArray = [25,387,1234,34,521,634,11];
...
let numericArray2 = [25,387,1234,34,521,634,11];
...
let numericArray3 =[25,387,1234,34,521,634,11];
let average= 0;
for (let i=0; i<numericArray3.length; i++){
    average= (average*i+numericArray3[i])/(i+1);
}
console.log('The average is:', average)

//Tömb elemeinek összege

let numericArray4 =[25,387,1234,34,521,634,11];
let sum = 0;
...
let numericArray5 = [25,387,1234,34,521,634,11];
let evenNumbers = 0;
...
function getNthMinElement (arr, nth) {
    const sortedArr = bubbleSort1(arr);
    return sortedArr[nth - 1];
}

const numericArray6 = [25,387,1234,34,521,634,11];
...
const numericArray8b = [25,387,1234,34,521,634,11];

console.log(linearSearch('This array contains 23:', numericArray8b, 23));
...
const numbers9 = [25,387,1234,34,521,634,11];

console.log(binarySearch('This array contains 23:', numbers9, 23));

//A tömb hányszor tartalmazza a 23-as számot

let numericArray10 = [25,387,1234,34,521,634,11];
let db = 0;
...
console.log('The ordered array:',bubbleSortImp(numericArray11));

//Javított buborékos elrendezés csökkenő sorrend
function bubbleSortImp3(arr){
    let swapped;
    let lastSwapped=arr.length-1; 
//    let count =1;
    do {
...
//            if (typeof(arr[i+1]) == "number" && (typeof(arr[i]) != "number" || arr[i] < arr[i + 1]))
               {
//                console.log('Type of ', arr[i], ' is:', typeof(arr[i]));
//                console.log('Type of ', arr[i+1], ' is:', typeof(arr[i+1]));
//                console.log('');
                let temp = arr[i+1];
                arr[i+1] = arr[i];
                arr[i] = temp;
...
console.log('The ordered array2:',bubbleSortImp3(numericArray12));
//console.log("The ordered array2:",bubbleSortImp3(numericArray12a));
...
const numericArray13 = [25,387,1234,34,521,634,11];
...
const numericArray15= [25,387,1234,34,521,634,11];
